...
class single_plot:
    ...
    def fill_single_json(self):
        ...
        if len(self.subplot_numerators) == 2:
            self.out_json["colors"] = ["kRed kWhite", "kBlue", "kRed", "kBlue"]
            self.out_json["marker_styles"] = [20, 20, 0, 20]
        ...
        try:
            if "shift" in self.plotlines:
                ...
                self.out_json["marker_styles"] = [20, 20, 20, 20, 0, 20, 20, 20]
                self.out_json["markers"] = ["HIST", "HIST", "HIST", "PE", "E2", "HIST", "HIST", "PE"]
                self.out_json["fill_styles"] = [1001, 1001, 1001, 1001, 3001, 1001, 1001, 1001]
