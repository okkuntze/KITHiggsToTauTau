...
def build_config(nickname, **kwargs):
  ...
  includes = [
    ...
    "HiggsAnalysis.KITHiggsToTauTau.data.ArtusConfigs.Run2MSSM2018.Includes.settingsVetoElectronID",
    ...
    "HiggsAnalysis.KITHiggsToTauTau.data.ArtusConfigs.Run2MSSM2018.Includes.settingsMinimalPlotlevelFilter_et"
  ]
