...
def build_list(**kwargs):
    ...
    quantities.extend(importlib.import_module("HiggsAnalysis.KITHiggsToTauTau.data.ArtusConfigs.Run2MSSM2018.Includes.weightQuantities").build_list(minimal_setup=minimal_setup))
    quantities.extend(importlib.import_module("HiggsAnalysis.KITHiggsToTauTau.data.ArtusConfigs.Run2MSSM2018.Includes.idQuantities").build_list(minimal_setup=minimal_setup))
    quantities.extend(importlib.import_module("HiggsAnalysis.KITHiggsToTauTau.data.ArtusConfigs.Run2MSSM2018.Includes.trgQuantities").build_list(minimal_setup=minimal_setup))
