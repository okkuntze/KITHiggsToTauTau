...
def build_config(nickname, **kwargs):
  ...
  log.debug("%s \n %25s %-30r \n %30s %-25s" % ("    Run2MSSM2018_base::", "btag_eff:", btag_eff, "analysis_channels: ", ' '.join(analysis_channels)))
  ...
  if isData or isEmbedded:
    if   re.search("Run2018|Embedding2018", nickname):      config["JsonFiles"] = ["$CMSSW_BASE/src/HiggsAnalysis/KITHiggsToTauTau/data/root/json/Cert_314472-325175_13TeV_17SeptEarlyReReco2018ABC_PromptEraD_Collisions18_JSON.txt"]
    elif   re.search("Run2017|Embedding2017", nickname):      config["JsonFiles"] = ["$CMSSW_BASE/src/HiggsAnalysis/KITHiggsToTauTau/data/root/json/Cert_294927-306462_13TeV_EOY2017ReReco_Collisions17_JSON_v1.txt"]
