...
def build_config(nickname, **kwargs):
  ...
  if year == 2016:   config["ZptRooWorkspace"] = "$CMSSW_BASE/src/HiggsAnalysis/KITHiggsToTauTau/data/root/scaleFactorWeights/htt_scalefactors_2017_v2.root" #TODO remeasure
  ...
  config["MetCorrectionMethod"] = "none" if isData else "meanResolution"
  ...
  if isData or isEmbedded:
    if   year == 2016:      config["JsonFiles"] = ["$CMSSW_BASE/src/HiggsAnalysis/KITHiggsToTauTau/data/root/json/Cert_271036-284044_13TeV_23Sep2016ReReco_Collisions16_JSON.txt"]
